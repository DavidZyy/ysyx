...
void Vtop___024root__traceInitSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+98,"top wen", false,-1);
        tracep->declQuad(c+79,"top rdata_1", false,-1, 63,0);
        tracep->declQuad(c+81,"top rdata_2", false,-1, 63,0);
        tracep->declQuad(c+83,"top operator_2", false,-1, 63,0);
        tracep->declQuad(c+77,"top result", false,-1, 63,0);
        tracep->declQuad(c+99,"top current_pc", false,-1, 63,0);
        ...
        tracep->declBit(c+75,"top u_decoder op_imm", false,-1);
        tracep->declBit(c+85,"top u_decoder op_system", false,-1);
        tracep->declBit(c+86,"top u_decoder funct3_000", false,-1);
        tracep->declBit(c+87,"top u_decoder funct12_000000000001", false,-1);
        tracep->declBit(c+76,"top u_decoder addi", false,-1);
        tracep->declBit(c+88,"top u_decoder ebreak", false,-1);
        tracep->declBit(c+75,"top u_decoder I_type", false,-1);
        tracep->declQuad(c+89,"top u_decoder I_imm", false,-1, 63,0);
        tracep->declBus(c+101,"top u_RegisterFile ADDR_WIDTH", false,-1, 31,0);
        tracep->declBus(c+102,"top u_RegisterFile DATA_WIDTH", false,-1, 31,0);
        tracep->declBit(c+65,"top u_RegisterFile clk", false,-1);
        tracep->declQuad(c+77,"top u_RegisterFile wdata", false,-1, 63,0);
        tracep->declBus(c+91,"top u_RegisterFile rd", false,-1, 31,0);
        tracep->declBit(c+98,"top u_RegisterFile wen", false,-1);
        tracep->declBus(c+92,"top u_RegisterFile rs1", false,-1, 31,0);
        tracep->declBus(c+93,"top u_RegisterFile rs2", false,-1, 31,0);
        tracep->declQuad(c+79,"top u_RegisterFile rdata_1", false,-1, 63,0);
        tracep->declQuad(c+81,"top u_RegisterFile rdata_2", false,-1, 63,0);
        {int i; for (i=0; i<32; i++) {
                tracep->declQuad(c+1+i*2,"top u_RegisterFile rf", true,(i+0), 63,0);}}
        tracep->declQuad(c+79,"top u_Alu operator_1", false,-1, 63,0);
        tracep->declQuad(c+83,"top u_Alu operator_2", false,-1, 63,0);
        tracep->declBit(c+76,"top u_Alu alu_add", false,-1);
        tracep->declQuad(c+77,"top u_Alu result", false,-1, 63,0);
        tracep->declQuad(c+94,"top u_Alu add_result", false,-1, 63,0);
        ...
        tracep->declQuad(c+96,"top u_PC next_pc", false,-1, 63,0);
        tracep->declBus(c+102,"top u_PC Pc_Reg WIDTH", false,-1, 31,0);
        ...
        tracep->declQuad(c+96,"top u_PC Pc_Reg din", false,-1, 63,0);
        tracep->declBit(c+98,"top u_PC Pc_Reg wen", false,-1);
    ...
    // Body
    {
        ...
        tracep->fullQData(oldp+73,(((- (QData)((IData)(
                                    ...
                                    & (((- (QData)((IData)(
                                        ...
                                        << 0xcU) | (QData)((IData)(
                                                                   (vlSelf->inst 
                                                                    >> 0x14U)))))),64);
        tracep->fullBit(oldp+75,((0x13U == (0x7fU & vlSelf->inst))));
                                    ...
                                    & (vlSelf->top__DOT__u_RegisterFile__DOT__rf
                                       ...
                                       + ((0x13U == 
                                          ...
                                          [(0x1fU & 
                                            (vlSelf->inst 
                                             >> 0x14U))])))),64);
        tracep->fullQData(oldp+79,(vlSelf->top__DOT__u_RegisterFile__DOT__rf
                                   [(0x1fU & (vlSelf->inst 
                                              >> 0xfU))]),64);
        tracep->fullQData(oldp+81,(vlSelf->top__DOT__u_RegisterFile__DOT__rf
                                   [(0x1fU & (vlSelf->inst 
                                              >> 0x14U))]),64);
        tracep->fullQData(oldp+83,(((0x13U == (0x7fU 
                                               & vlSelf->inst))
                                     ? ((- (QData)((IData)(
                                                           (0x13U 
                                                            == 
                                    ...
                                    [(0x1fU & (vlSelf->inst 
                                               >> 0x14U))])),64);
        tracep->fullBit(oldp+85,((0x73U == (0x7fU & vlSelf->inst))));
        tracep->fullBit(oldp+86,((0U == (7U & (vlSelf->inst 
                                               >> 0xcU)))));
        tracep->fullBit(oldp+87,((1U == (vlSelf->inst 
                                         >> 0x14U))));
        ...
        tracep->fullQData(oldp+89,((((- (QData)((IData)(
                                     ...
                                     << 0xcU) | (QData)((IData)(
                                                                (vlSelf->inst 
                                                                 >> 0x14U))))),64);
        tracep->fullIData(oldp+91,((0x1fU & (vlSelf->inst 
                                             >> 7U))),32);
        tracep->fullIData(oldp+92,((0x1fU & (vlSelf->inst 
                                             >> 0xfU))),32);
        tracep->fullIData(oldp+93,((0x1fU & (vlSelf->inst 
                                             >> 0x14U))),32);
        tracep->fullQData(oldp+94,((vlSelf->top__DOT__u_RegisterFile__DOT__rf
                                    [(0x1fU & (vlSelf->inst 
                                               >> 0xfU))] 
                                    + ((0x13U == (0x7fU 
                                                  & vlSelf->inst))
        ...
        tracep->fullQData(oldp+99,(vlSelf->top__DOT__current_pc),64);
        tracep->fullIData(oldp+101,(0x20U),32);
