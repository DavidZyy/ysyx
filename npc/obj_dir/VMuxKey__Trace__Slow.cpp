...
void VMuxKey___024root__traceInitSub0(VMuxKey___024root* vlSelf, VerilatedVcd* tracep) VL_ATTR_COLD;
...
void VMuxKey___024root__traceInitTop(VMuxKey___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        VMuxKey___024root__traceInitSub0(vlSelf, tracep);
    }
}

void VMuxKey___024root__traceInitSub0(VMuxKey___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VMuxKey__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
void VMuxKey___024root__traceFullTop0(void* voidSelf, VerilatedVcd* tracep) VL_ATTR_COLD;
void VMuxKey___024root__traceChgTop0(void* voidSelf, VerilatedVcd* tracep);
void VMuxKey___024root__traceCleanup(void* voidSelf, VerilatedVcd* /*unused*/);
...
void VMuxKey___024root__traceRegister(VMuxKey___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        tracep->addFullCb(&VMuxKey___024root__traceFullTop0, vlSelf);
        tracep->addChgCb(&VMuxKey___024root__traceChgTop0, vlSelf);
        tracep->addCleanupCb(&VMuxKey___024root__traceCleanup, vlSelf);
    }
}

void VMuxKey___024root__traceFullSub0(VMuxKey___024root* vlSelf, VerilatedVcd* tracep) VL_ATTR_COLD;

void VMuxKey___024root__traceFullTop0(void* voidSelf, VerilatedVcd* tracep) {
    VMuxKey___024root* const __restrict vlSelf = static_cast<VMuxKey___024root*>(voidSelf);
    VMuxKey__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
    {
        VMuxKey___024root__traceFullSub0((&vlSymsp->TOP), tracep);
    }
}

void VMuxKey___024root__traceFullSub0(VMuxKey___024root* vlSelf, VerilatedVcd* tracep) {
    if (false && vlSelf) {}  // Prevent unused
    VMuxKey__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
