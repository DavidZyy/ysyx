...
void Vtop___024root__traceChgSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->chgQData(oldp+82,(((0x13U == (0x7fU 
                                   ...
                                   [(0x1fU & (vlSelf->inst 
                                              >> 0x14U))])),64);
        tracep->chgBit(oldp+84,((0x73U == (0x7fU & vlSelf->inst))));
        tracep->chgBit(oldp+85,((0U == (7U & (vlSelf->inst 
                                              >> 0xcU)))));
        tracep->chgBit(oldp+86,((1U == (vlSelf->inst 
                                        >> 0x14U))));
        tracep->chgBit(oldp+87,(((IData)((0x73U == 
                                          (0x707fU 
                                           & vlSelf->inst))) 
                                 & (1U == (vlSelf->inst 
                                           >> 0x14U)))));
        tracep->chgQData(oldp+88,((((- (QData)((IData)(
                                    ...
                                    << 0xcU) | (QData)((IData)(
                                                               (vlSelf->inst 
                                                                >> 0x14U))))),64);
        tracep->chgIData(oldp+90,((0x1fU & (vlSelf->inst 
                                            >> 7U))),32);
        tracep->chgIData(oldp+91,((0x1fU & (vlSelf->inst 
                                            >> 0xfU))),32);
        tracep->chgIData(oldp+92,((0x1fU & (vlSelf->inst 
                                            >> 0x14U))),32);
        tracep->chgQData(oldp+93,((vlSelf->top__DOT__u_RegisterFile__DOT__rf
                                   [(0x1fU & (vlSelf->inst 
                                              >> 0xfU))] 
                                   + ((0x13U == (0x7fU 
                                                 & vlSelf->inst))
