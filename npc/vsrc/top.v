...
module EXU(	// <stdin>:2532:3
      ...
      automatic logic [3:0][1:0] _GEN =
        {{2'h0},
         ...
         {from_ISU_bits_ctrl_sig_fu_op == 3'h4
            ...
            : 2'h3},
         {{1'h0, _from_ISU_ready_output & from_ISU_valid}}};	// <stdin>:2532:3, src/main/scala/chisel3/util/Decoupled.scala:52:35, src/main/scala/rv32e/EXU.scala:30:35, :42:24, :43:20, :45:{19,25}, :49:{48,69}, :50:{23,29}, :52:23, :56:{19,25}, :60:19
      state <= _GEN[state];	// src/main/scala/rv32e/EXU.scala:42:24, :43:20, :45:19, :49:69, :56:19, :60:19
    end
  end // always @(posedge)
  ...
  Alu Alu_i (	// src/main/scala/rv32e/EXU.scala:25:35
    .io_in_src1
      (from_ISU_bits_ctrl_sig_src1_op == 2'h1
         ? from_ISU_bits_pc
         : from_ISU_bits_ctrl_sig_src1_op == 2'h2 ? from_ISU_bits_rdata1 : 32'h0),	// src/main/scala/rv32e/EXU.scala:45:25, :50:29, :69:73
    .io_in_src2
      ((&from_ISU_bits_ctrl_sig_src2_op)
         ? from_ISU_bits_imm
         : from_ISU_bits_ctrl_sig_src2_op == 2'h2 ? from_ISU_bits_rdata2 : 32'h0),	// src/main/scala/rv32e/EXU.scala:50:29, :69:73, :73:73
  ...
  Lsu_simpleBus Lsu_i (	// src/main/scala/rv32e/EXU.scala:30:35
    .clock                  (clock),
    .reset                  (reset),
    .io_in_valid            (state == 2'h2),	// src/main/scala/rv32e/EXU.scala:42:24, :50:29, :89:53
  ...
  assign to_WBU_valid = &state;	// <stdin>:2532:3, src/main/scala/rv32e/EXU.scala:42:24, :64:48
