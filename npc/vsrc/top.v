...
module top(
  ...
  EXU_pipeline EXU_i (
    ...
    .lsu_to_mem_ar_ready              (_sram_i2_axi_ar_ready),
    .lsu_to_mem_r_valid               (_sram_i2_axi_r_valid),
    .lsu_to_mem_r_bits_data           (_sram_i2_axi_r_bits_data),
    .lsu_to_mem_aw_ready              (_sram_i2_axi_aw_ready),
    .lsu_to_mem_b_valid               (_sram_i2_axi_b_valid),
