...
module EXU_pipeline(
  ...
  wire [31:0] _predictWrong_T_5 = from_ISU_bits_pc + 32'h4;
  ...
  assign to_WBU_bits_redirect_valid =
    (taken & npc == _predictWrong_T_5 | ~taken & npc != _predictWrong_T_5)
    & (_to_ISU_hazard_isBR_T | _to_ISU_hazard_isBR_T_1) & from_ISU_valid;
